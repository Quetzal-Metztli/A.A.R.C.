...
En qué te inspiraste para escribirlo?
	como ta no me estoy inspirando en un texto su no de una chica que invitaba a la organización social para el colapso, pero solo hacia invitaciones, quiero llevarlo mas lejos y organizarme en un movimiento que ademas invite a organizarse a los demás, y no limitarse a solo esperar el colapso si no aspirar a una revolución por eso la documentación para ayudar a cualquiera a organizarse en sus propias condiciones. 
	otra razón no fue por inspiración si no como respuesta a un problema, me eh unido a grupos que dicen ser revolucionarios pero replican los mismos problemas del capitalismo, (me censuraron XD), peleaban con enemigos imaginarios como familias que hicieron pactos para ser los mas poderosos, no tenían organización interna y no ofrecían una solución o explicaban que pasaba después de la revolución.
	eso me hizo darme cuenta que si hay espiritu en algunas personas para la revolucion solo hace falta encontrarlos, aunque no sean comunistas ofreserles la mano y enseñarles a cerca del marxismo como modo de analicis para que vean los problemas estructurales del sistema

Cómo funcionaría esa organización en la práctica?
	seria usar el Internet como un medio para organizarse y lograr organizar gente en puntos en la vida real con diferentes propósitos como ollas comunes, manifestaciones, ayudar a personas, construir huertas, y enseñar sobre todo eso
 

Qué entiendes por soberanía digital?
	la soberanía digital es dejar de depender de esas empresas de software capitalistas y usar alternativas de software libre 
> Que se necesita para que un software sea libre?
	Según la fundación del software libre que lo defiende se necesitan de 4 libertades para un programas ser software libre:
	- **Libertad 0:** Libertad de **ejecutar** el programa como quieras y para cualquier propósito.
	- **Libertad 1:** Libertad de **estudiar** cómo funciona el programa y cambiarlo (para lo cual el acceso al código fuente es obligatorio).
